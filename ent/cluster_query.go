...
func (cq *ClusterQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ClusterQuery) FirstIDX(ctx context.Context) uint64 {
...
func (cq *ClusterQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ClusterQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (cq *ClusterQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (cq *ClusterQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(cluster.FieldDeleteTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Cluster.Query().
//		Select(cluster.FieldDeleteTime).
//		Scan(ctx, &v)
